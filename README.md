...
- `fastProcessingEnvironments`: _default_: ['beta'] | An array of environment names (e.g., `['beta', 'qa']`). If the current `ENV` matches one of these, the `maximumBatchingWindow` for the consumer will be set to `0` for faster message processing.
