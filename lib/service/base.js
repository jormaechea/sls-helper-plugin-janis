...
module.exports = async ({
	...
	console.log('serviceConfig', JSON.stringify(serviceConfig, null, 2));
	...
	// const serviceEnv = titleCase(custom.stage);
				...
				ServiceExecutionRole: {
					...
					Properties: {
						...
						ManagedPolicyArns: [
							...
							'arn:aws:iam::${aws:accountId}:policy/JanisLambdaBasePolicyBeta'
							// `arn:aws:iam::\${aws:accountId}:policy/JanisLambdaBasePolicy${serviceEnv}`
						],
						Policies: [
							{
