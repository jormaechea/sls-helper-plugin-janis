...
module.exports = ({
	...
	const shouldAddTraceLayer = TRACE_ACCOUNT_ID && JANIS_TRACE_EXTENSION_VERSION;

	const layers = [
		...provider?.layers || [],
		...shouldAddTraceLayer ? [`arn:aws:lambda:\${aws:region}:${TRACE_ACCOUNT_ID}:layer:trace:${JANIS_TRACE_EXTENSION_VERSION}`] : []
	];
