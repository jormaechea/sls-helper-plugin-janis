...
module.exports = class SQSHelper {
	...
	static setConfigsWithDefaults(userConfigs) {
		...
		this.consumerProperties = {
			...consumerDefaultsValue,
			...userConfigs.consumerProperties,
			maximumBatchingWindow: getMaximumBatchingWindow(this.consumerProperties)
		};
		...
		this.delayConsumerProperties = {
			...consumerDefaultsValue,
			...userConfigs.delayConsumerProperties,
			maximumBatchingWindow: getMaximumBatchingWindow(this.delayConsumerProperties)
		};
		...
		if(userConfigs.dlqConsumerProperties) {
			this.dlqConsumerProperties = {
				...dlqConsumerDefaultsValue,
				...userConfigs.dlqConsumerProperties,
				maximumBatchingWindow: getMaximumBatchingWindow(this.dlqConsumerProperties)
			};
		} else {
